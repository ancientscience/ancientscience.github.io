...
\node[scale=1.6, at={(0in, 1.95in)}]
    {\Huge \bfseries \textcolor{BurntOrange}{\RaisedText{Catalogue 2022}}};    
    
\node[scale=0.75, at={(0in, -1.5in)}]
    {\Huge \bfseries \textcolor{BurntOrange}{\RaisedText{Multi-color and Hardcover editions are also available}}};
	
\node[scale=0.8, at={(0in, -1.8in)}]
    {\Huge \bfseries \textcolor{BurntOrange}{\RaisedText{Flat 20\% Off, Bulk Discount 30-50\%}}};

\node[scale=0.8, at={(0in, -2.1in)}]

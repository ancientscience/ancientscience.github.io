...
\documentclass[12pt, dvipsnames, svgnames]{article}
%\PassOptionsToPackage{cmyk}{xcolor}
\usepackage[cmyk]{xcolor}
\usepackage{comment, calligra}
\usepackage[paperheight=8.25in,paperwidth=5.46in,margin=0in]{geometry}
\usepackage{listings}
%\usepackage{pdfpages}
...
\node[shading=ball, ball color=vividvioletcmyk, minimum width=13in, minimum height=9.25in,text=white,ultra thick] 
...
\node[scale=0.6, align=left, rotate=0, color=limegreencmyk, rounded corners=5ex,ultra thick] at(0in,-2in) {
...
\node[scale=.45, at={(0in, 3.3in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries {\color{Snow}{Solving Problems}}};


\node[scale=0.4, at={(0in, 2.9in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{Snow} { \RaisedText{using}}};


\node[scale=0.45, at={(0in, 2.5in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries  {\color{Snow} \RaisedText{Dynamic Programming}}};

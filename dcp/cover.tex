...
\def\nodeshadowed[#1]#2;{\node[scale=1,above,#1]{#2};\node[scale=1,
 ...
 \special{pdf:docinfo <<
        /Title (Discipline of Competitive Programming)
...
\colorlet{SubTitleColor}{BurntOrange}
...
\node[shade,top color=White, bottom color=YellowOrange, minimum width=15in, minimum height=9.25in,text=white,ultra thick] 
...
\node[scale=0.65, at={(0in, 0in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{TitleColor}{\RaisedText{Discipline}}};

\node[scale=0.4, at={(0in, -0.5in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{SubTitleColor} { \RaisedText{of}}};


\node[scale=0.75, at={(0in, -1.0in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{SubTitleColor} {\RaisedText{Competitive}}};

\node[scale=0.9, at={(0in, -1.6in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries  { \color{SubTitleColor} \RaisedText{Programming}}};

\node[scale=0.5, at={(0in, -2.8in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries  {\calligra \color{Red} \RaisedText{A Hacker's Perspective}}};

\node[scale=0.4, at={(0in, -7.0in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{Orange} {\RaisedText{Chandra Shekhar Kumar}}};


\node[scale=0.4, at={(0in, -7.8in)}]
    {\setmainfont{Cooper Black}

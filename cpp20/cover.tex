% spine = 0.002252 * 778 = 1.752
% Minimum Cover Width: Bleed + Back Cover Trim Size + Spine Width + Front Cover Trim Size + Bleed =  0.125" + 8.5" + 1.752" + 8.5" + .125" = 19.002''
% Minimum Cover Height: Bleed + Book Height Trim Size + Bleed = 0.125" + 11.69" + .125" = 11.94"
\documentclass[12pt, svgnames, dvipsnames]{article}
%\PassOptionsToPackage{cmyk}{xcolor}
\usepackage{comment, calligra}
\usepackage{pifont, dingbat, enumitem}
\usepackage[paperheight=11.94in,paperwidth=10.45in,margin=0in]{geometry}
%\usepackage{pdfpages}
...
\newcommand*{\RaisedText}[1]{%
  \begingroup
    \leavevmode
    \rlap{\kern-1pt\raise2pt\hbox{\color{White}#1}}%
    \rlap{\kern1pt\raise-2pt\hbox{\color{Black}#1}}%
    \hbox{#1}%
  \endgroup
}
...
\colorlet{TitleColor}{Cyan}
\colorlet{SubTitleColor}{Cyan}
...
%\usepackage[ISBN=978-9354372926,SC0]{ean13isbn}
...
\node[shade,top color=White, bottom color=Cyan, minimum width=20in, minimum height=12in,text=white,ultra thick] 
...
\node[scale=1.3, at={(0in, 0in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{TitleColor}{\RaisedText{Elements}}};

\node[scale=0.9, at={(0in, -0.9in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{SubTitleColor} { \RaisedText{of}}};


\node[scale=1.5, at={(0in, -1.8in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{SubTitleColor} {\RaisedText{C++20}}};


\node[scale=0.6, at={(0in, -7.2in)}]
    {\setmainfont{Cooper Black}
\fontsize{2cm}{1.5cm}\selectfont \bfseries \textcolor{LimeGreen} {\RaisedText{Chandra Shekhar Kumar}}};


\node[scale=0.5, at={(0in, -7.8in)}]
    {\setmainfont{Cooper Black}
...
%design spine 
\node[scale=1, rotate=-90,  minimum width=11.3in, minimum height=2.1in,ultra thick] 
at(-4.5in,0.0) 
{
\setmainfont{Cooper Black}
\fontsize{2.0cm}{1.5cm}\selectfont
\begin{varwidth}{17in}
\color{Cyan}
\RaisedText{Elements of C++20}
\end{varwidth}
};
